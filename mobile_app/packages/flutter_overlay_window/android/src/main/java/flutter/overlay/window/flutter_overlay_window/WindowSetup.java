...
public abstract class WindowSetup {
    ...
    // PATCH (see PATCH.md): guards `messenger` against being overwritten once
    // the overlay's own separately-created engine attaches this same plugin.
    static boolean mainMessengerSet = false;
